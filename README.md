...
Extend `ExampleTest` from `TestCaseAbstract` to autoload the general `ExampleTest.json` or method related `ExampleTest_testMethod.json` located inside the `tests\provider` directory:
